...
//  WrittenMyRecipes
//
//  Created by Tamas Sagi on 30/04/2018.
...
class TestData {
    let detailTableViewSections = ["Ingredients","Steps"]
    
    let dummyRecipe = [["2kg topside of beef",
    ...
    let dummyRows = [["section 1 row 1","section 1 row 2","section 1 row 3"],
                     ["section 2 row 1","section 2 row 2","section 2 row 3","section 2 row 4"],
                     ["section 3 row 1"]
    ]
